...
# subset special cases
result_df[c("barcode01", "barcode02", "barcode04", "barcode86")]
...
col_fun = colorRamp2(c(-3, 5), c("white", "red"))

num_bins = 50
ha = rowAnnotation(foo = anno_mark(at = seq(1, ncol(mat) + num_bins, by = num_bins), 
